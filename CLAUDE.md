...
- **Copy voice**: all user-facing strings (empty states, errors, banners, buttons, marketing) follow `docs/copy-voice.md` — proof over claims, no disclaimers, verb-led CTAs.
