...
- [ ] **T3.4 Live tab** — ← IN FLIGHT (Codex dispatched 2026-07-04; spec: `docs/specs/t3.4-live-tab.md`). List/filters/table already shipped in T3.1b; this adds the Live route + rail from the presence registry. Verify: visual judge vs mock's "Live now" panel (seed via `/__test/do/presence/ping`), poll pauses when tab hidden.
