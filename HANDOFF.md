...
- [ ] **T4.4 CI (GitHub Actions)** — ← IN FLIGHT (Codex dispatched 2026-07-04; spec: `docs/specs/t4.4-ci.md`). check/test/budgets/e2e/mirror/build jobs, pinned vp via pnpm exec, no secrets, every workflow command proven locally.
