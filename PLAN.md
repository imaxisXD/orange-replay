...
| T2.2 | `packages/sdk` core: <2 KB loader (pre-buffer errors/clicks), session mgmt (UUIDv7, sessionStorage+cookie, tab id, 10-min idle rotation), remote config fetch, masking defaults (`data-orange-block`, mask-all-inputs)                                                                                                                                                                                                             | T2.1      |
...
| T2.4 | Tests + budgets: unit (happy-dom), wire-conformance against `packages/shared` fixtures, bundle-size budget in CI config (core 32 KB target / 36 KB hard ceiling, loader ≤ 2 KB gzip)                                                                                                                                                                                                                                               | T2.3      |
