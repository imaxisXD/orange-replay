...
function TooltipBoxInner({
  ...
  const panelClassName = cn(
    // The 1px divider rim separates the panel from dark chart fills where
    // shadow-lg alone is invisible (dark on dark).
    "min-w-[140px] overflow-hidden rounded-lg border border-[color:var(--divider)] text-chart-tooltip-foreground shadow-lg",
