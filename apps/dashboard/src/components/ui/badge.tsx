...
const badgeColors = {
  ...
  lime: "oklch(0.768 0.204 130.85)",
  green: "oklch(0.723 0.192 149.579)",
  emerald: "oklch(0.696 0.149 162.48)",
  ...
  purple: "oklch(0.627 0.233 303.9)",
  fuchsia: "oklch(0.667 0.259 322.15)",
    ...
    const colorStyle = isSolid
      ? color === "gray"
        ...
        : {
            ...
            backgroundColor: `color-mix(in oklch, ${colorValue} 15%, var(--background))`,
          }
      : {};
