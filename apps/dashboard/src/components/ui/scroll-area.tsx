...
// Base UI flavour of the Fluid Functionalism scroll area: shape-system
// scrollbar with a native overflow fallback on touch-primary devices.
// Scrollbar machinery adapted from Lina by SameerJS6
// (https://lina.sameer.sh); Base UI keeps scrollbars mounted while scrollable
// and exposes hover/scroll state as data attributes for visibility transitions.
