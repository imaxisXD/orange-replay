import type { ICrossOriginIframeMirror } from "../../rrweb-types/index.ts";
export default class CrossOriginIframeMirror implements ICrossOriginIframeMirror {
  private iframeIdToRemoteIdMap: WeakMap<HTMLIFrameElement, Map<number, number>> = new WeakMap();
  private iframeRemoteIdToIdMap: WeakMap<HTMLIFrameElement, Map<number, number>> = new WeakMap();
  ...
  getRemoteId(iframe: HTMLIFrameElement, id: number, map?: Map<number, number>): number {
