...
let loaderOptions = loaderWindow.__orInit;
if (!isInitOptions(loaderOptions) && Array.isArray(loaderWindow.__orq)) {
...
if (isInitOptions(loaderOptions)) init(loaderOptions);
