...
// Project creation carries only one workspace id. Keep the public write
// boundary small even when content-length is missing or dishonest.
export const MAX_PROJECT_CREATE_BODY_BYTES = 1024;
...
export const CLOSE_SESSION_AFTER_IDLE_MS = 10 * 60_000;
